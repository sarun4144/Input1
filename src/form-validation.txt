    ...
    return (
        <div className='mt-3 mb-5 mx-auto p-3 rounded' style={{ width: '400px', background: '#cee' }}>
            ...
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className='form-group mb-3'>
                    <label htmlFor='name'>ชื่่อสินค้า</label>
                    <input type="text" id='name' name='name' maxLength='50' className='form-control form-control-sm'
                ...
                <div className='form-group mb-3'>
                    ...
                    <textarea type="number" id='price' name='price' rows='2' maxLength='250' className='form-control form-control-sm'
                        {...register('price', { validate: value => parseFloat(value) > 0 })}
                    ></textarea>
                    {errors.detail && <div style={err}>กำหนดราคาสินค้าเป็นตัวเลขมากกว่า 0 </div>}
                </div>
                <div className='form-group mb-3'>
                ...
                <div className='form-group mb-3'>
                    ...
                    <input type="date" id='dateAdd' name='dateAdd' className='form-control form-control-sm'></input>
                </div>
                <div className='form-group mb-3'>
